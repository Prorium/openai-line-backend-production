...
// LINE Bot ID APIエンドポイント
app.get('/api/line-bot-id', (req, res) => {
    const lineBotId = process.env.LINE_BOT_ID || '@234zjfds';
    res.json({ lineBotId });
});
...
app.listen(PORT, '0.0.0.0', () => {
    ...
    console.log(`LINE Bot ID API: http://localhost:${PORT}/api/line-bot-id`);
